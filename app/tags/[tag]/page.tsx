...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (total === 0) {
    return { title: "Not found | Okata Studios" };
  }

  const title = `${label} — Frontend Dev & Motion Design Work | Okata Studios`;
  const description = `Frontend development and motion design work tagged "${label}" by Okata Studios — projects, reels, and resources.`;
