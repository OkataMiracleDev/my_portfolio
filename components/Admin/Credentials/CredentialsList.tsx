...
import { deleteCredentialAction, reorderCredentialsAction } from "@/app/admin/credentials/actions";

type Credential = typeof animateCredentials.$inferSelect;

export default function CredentialsList({ initialItems }: { initialItems: Credential[] }) {
  ...
  function handleDrop(dropIndex: number) {
    ...
    setItems(next);
    setDragIndex(null);
    reorderCredentialsAction(next.map((item) => item.id));
  }
