...
const Hero = () => {
  ...
  return (
    <div className="relative h-[30vh] py-[45vh] md:py-[43vh]" id="home">
      ...
      <button
        ...
        className="hire-me-btn font-[poppins] font-medium text-white backdrop-blur-sm bg-[#5a3b5e4b] shadow-md shadow-gray-500 px-4 py-2 rounded-xl cursor-pointer transition-all duration-300 flex absolute top-[28%] md:top-[30%] md:left-[60%] left-[64%] lg:left-[60%] xl:top-[28%] xl:left-[59%] translate-x-[-50%]"
      >
        Hire Me!
      </button>
