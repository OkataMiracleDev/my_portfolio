...
const Hero = () => {
  return (
    <div>
      ...
      <div className='bg-green-300 border-2 border-green-400 w-5 h-5 md:w-8 md:h-8 rounded-full absolute top-[53%] left-[63%] md:top-[45%] md:left-[61%] xl:top-[44%] xl:left-[60%] '></div>
        <Image src="/images/Miracle_Okata.jpg" alt="character" width={200} height={200} className='rounded-full' />
        <h1>Hi. I&apos;m mimi</h1>
        <h1>FrontEnd Developer</h1>
      </div>

      <a className='flex absolute top-[28%] md:top-[28%] md:left-[62%] left-[64%] lg:left-[60%] xl:left-[57%] translate-x-[-50%]' href="">
