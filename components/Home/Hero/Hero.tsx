...
const Hero = () => {
  return (
    <div>
      ...
      <div className='bg-green-300 border-2 border-green-400 w-5 h-5 md:w-8 md:h-8 rounded-full absolute top-[53%] left-[61%] md:top-[45%] md:left-[59%] xl:top-[42%] xl:left-[57%] '></div>
