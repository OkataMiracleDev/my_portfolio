...
const PhotoCollage = () => {
  return (
    <div className='absolute rotate-[68deg] md:rotate-[66deg] -bottom-[33%] right-[38%] md:-bottom-[60%] lg:-bottom-[122%] md:right-0 md:left-[47%] md:-translate-x-[50%] '>
        <div className='w-full flex flex-col justify-center items-center'>
            <div className='bg-gray-100 w-[6rem] h-[18rem] md:w-[10rem] md:h-[30rem] lg:w-[20rem] lg:h-[60rem] lg:hover:w-[23rem] lg:hover:h-[69rem] grid grid-rows-3 px-2 py-2 gap-2 md:gap-4 shadow-md shadow-gray-300 transition-all duration-300'>
